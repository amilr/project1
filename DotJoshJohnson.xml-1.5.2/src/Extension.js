...
function activate(ctx) {
    ...
    ctx.subscriptions.push(vsc.languages.registerDocumentFormattingEditProvider(LANG_XML, new Formatting_1.XmlFormattingEditProvider()), vsc.languages.registerDocumentRangeFormattingEditProvider(LANG_XML, new Formatting_1.XmlFormattingEditProvider()), vsc.languages.registerCompletionItemProvider(LANG_XQUERY, new Completion_1.XQueryCompletionItemProvider(), ':', '$'));
